...
<html lang="en">
    ...
    <head>
        ...
        <title>Change Pass Page - Neoncart HTML5 Template</title>
    ...
    <body>
        ...
        <main>
            ...
            <section class="breadcrumb_section text-white text-center text-uppercase d-flex align-items-end clearfix" data-background="assets/images/breadcrumb/bg_01.jpg">
                ...
                <div class="container">
                    <h1 class="page_title text-white">Change Pass Page</h1>
            ...
            <section class="register_section sec_ptb_140 has_overlay parallaxie clearfix" data-background="assets/images/backgrounds/bg_22.jpg">
                ...
                <div class="container">
                    <div class="reg_form_wrap login_form" data-background="assets/images/reg_bg_01.png">
                        <form action="authen?action=changepass" method="POST">
                            <div class="reg_form">
                                <h2 class="form_title text-uppercase text-center">Change Pass</h2>
                                <div class="form_item">
                                ...
                                <button type="submit" class="custom_btn bg_default_red text-uppercase mb_50">Change Pass</button>
                                
                                <div class="create_account text-center">
                                    <h4 class="small_title_text text-center text-uppercase">Want to go back?</h4>
                                    <a class="create_account_btn text-uppercase" href="#!">Home</a>
                                </div>
                            </div>
                        </form>
                    </div>
