    ...
    <body id="body" class="vertical-layout vertical-menu-modern dark-layout 2-columns ecommerce-application navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="dark-layout">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="personal-info">
                                                                <h5 class="card-text text-muted">Personal Information</h5>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="role-address">
                                                                <h5 class="card-text text-muted">Role & Address</h5>
                                                                <br>
                                                                <div class="form-group">
                                                                    <label>Role:</label>
        ...
        <script>
                ...
                function validateUpdateAccountForm() {
                    ...
                    if (genderID === '') {
                        $('#genderError1').html('Please choose brand!');
                    }
                    if (accountDob === '') {
                        $('#dobError1').html('Please choose dob!');
                    }
                    ...
                    } else if (!/^(?!.*\s{2})[A-Za-z@.\s]+$/.test(accountEmail1)) {
                        $('#emailError1').html('Email must contain only letters');
                    }

                    if (accountAddress === '') {
                        $('#addressError1').html('Email cannot be blank');
                    } else if (accountAddress.length < 3) {
                        $('#addressError1').html('Email must be at least 3 characters long.');
                    } else if (!/^(?!.*\s{2})[A-Za-z0-9,\s]+$/.test(accountAddress)) {
                        $('#addressError1').html('Email must contain only letters');
                    }
                    ...
                    } else if (!/^(?!.*\s{2})[A-Za-z0-9\s]+$/.test(accountUsername)) {
                        $('#usernameError1').html('Username must contain only letters and numbers');
                    }

                    if (accountPhonenumber === '') {
                        $('#phonenumberError1').html('Phone number cannot be blank');
                    } else if (!/^\d+$/.test(accountPhonenumber) || ParseInt(accountPhonenumber) <= 0 || ParseInt(accountPhonenumber) > 11) {
                        $('#phonenumberError1').html('Phone number must contain only numbers and be larger than zero and smaller than eleven');
                    }
