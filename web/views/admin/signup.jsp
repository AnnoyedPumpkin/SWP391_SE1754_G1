<%-- 
    Document   : register
    Created on : Jan 29, 2024, 5:09:34 PM
    Author     : admin
--%>
                            ...
                            <div class="card bg-authentication rounded-0 mb-0">
                                <div class="row m-0">
                                    <div class="col-lg-6 d-lg-block d-none text-center align-self-center pl-0 pr-3 py-0">
                                        <img src="${pageContext.request.contextPath}/app-assets/images/pages/register.jpg" alt="branding logo">
                                    </div>
                                            ...
                                            <div class="card-content">
                                                <div class="card-body pt-0">
                                                    <form action="../admin/authen?action=register" method = "POST">
                                                        ...
                                                        <div class="form-label-group">
                                                            <input type="password" name="password2"  id="inputConfPassword" class="form-control" placeholder="Confirm Password" required>
                                                            <label for="inputConfPassword">Confirm Password</label>
                                                        </div>
                                                        <div style = "color: red">
                                                            ${error}
                                                        </div>
                                                        <a href="${pageContext.request.contextPath}/admin/authen?action=login" class="btn btn-outline-primary float-left btn-inline mb-50">Login</a>
                                                        <button type="submit" class="btn btn-primary float-right btn-inline mb-50">Register
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
