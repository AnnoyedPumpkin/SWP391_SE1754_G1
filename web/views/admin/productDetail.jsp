                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group breadcrum-right">
                                    <a style="float:right" class="btn btn-success btn-equal-size view-options mb-2 mb-md-0 flex-fill" href="${pageContext.request.contextPath}/admin/manageproduct?page=update-product&productID=${productForm.id}">
