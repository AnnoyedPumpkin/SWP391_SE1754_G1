                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <c:if test="${not empty status && status ne 'null' && status eq '0'}">
                                                <h4 style="color: red; font-style: italic;">***Warning: Any accounts after change hide status of product will be deleted after 30 days since the day you changed status.</h4> 
                                            </c:if>
                                                    ...
                                                    <c:forEach items="${listAf}" var="a">
                                                        <tr>
                                                            ...
                                                            <c:if test="${a.status eq '0'}">
                                                                <td class="align-middle px-2 py-2 border-bottom">${a.remainingDayBeforeDelete}</td>
                                                            </c:if>
