                                    ...
                                    <div class="row mb-5 mt-2">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="productnameError1" class="error"></div>
                                            </div>
                                            <div class="form-group">
                                                <label for="productPrice">Product Price: </label>
                                                <input type="text" class="form-control" id="productpriceInput1" name="productPrice" value="${productForm.price}">
                                                <div id="productpriceError1" class="error"></div>
                                            </div>
                                            <div class="form-group">
                                                <label for="productDescription">Product Description: </label>
                                                <input type="text" class="form-control" id="productdescriptionInput1" name="productDescription" value="${productForm.description}">
