<%-- Document : login Created on : Jan 11, 2024, 12:32:33 AM Author : LENOVO --%>
                                ...
                                <div class="brand_logo">
                                    <a class="brand_link" href="index.html">
                                        <img src="${pageContext.request.contextPath}/assets/images/logo/logo_27_1x.png"
                                            srcset="${pageContext.request.contextPath}/assets/images/logo/logo_27_2x.png 2x"
                                            alt="logo_not_found">
                                    </a>
                                                        ...
                                                        <div class="row mt__30">
                                                            <div class="col-lg-3">
                                                                <div class="page_links">
                                                                    ...
                                                                    <ul class="ul_li_block">
                                                                        <li><a href="carparts_shop.html">Shop Page</a>
                                                                        </li>
                                                                        <li><a href="carparts_shop_grid.html">Shop
                                                                                Grid</a></li>
                                                                        <li><a href="carparts_shop_list.html">Shop
                                                                                List</a></li>
                                                                ...
                                                                <div class="page_links">
                                                                    ...
                                                                    <ul class="ul_li_block">
                                                                        <li><a href="classic_ecommerce_shop.html">Shop
                                                                                Page</a></li>
                                                                        <li><a
                                                                                href="classic_ecommerce_shop_details.html">Shop
                                                                                Details</a></li>
                                                                    </ul>
                                                                </div>
                                                                ...
                                                                <div class="page_links">
                                                                    ...
                                                                    <ul class="ul_li_block">
                                                                        <li><a href="fashion_shop.html">Shop Page</a>
                                                                        </li>
                                                            ...
                                                            <div class="col-lg-3">
                                                                ...
                                                                <div class="page_links">
                                                                    ...
                                                                    <ul class="ul_li_block">
                                                                        <li><a href="gadget_shop.html">Shop Page</a>
                                                                        </li>
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="page_links">
                                                                    ...
                                                                    <ul class="ul_li_block">
                                                                        <li><a href="medical_shop.html">Shop Page</a>
                                                                        </li>
                                                                ...
                                                                <div class="page_links">
                                                                    ...
                                                                    <ul class="ul_li_block">
                                                                        <li><a href="modern_shop.html">Shop Page</a>
                                                                        </li>
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="page_links">
                                                                    ...
                                                                    <ul class="ul_li_block">
                                                                        <li><a href="simple_shop.html">Shop Page</a>
                                                                        </li>
                                                                ...
                                                                <div class="page_links">
                                                                    ...
                                                                    <ul class="ul_li_block">
                                                                        <li><a href="sports_shop.html">Shop Page</a>
                                                                        </li>
                                                                ...
                                                                <div class="page_links">
                                                                    ...
                                                                    <ul class="ul_li_block">
                                                                        <li><a href="lookbook_creative_shop.html">Shop
                                                                                Page</a></li>
                                                                        <li><a
                                                                                href="lookbook_creative_shop_details.html">Shop
                                                                                Details</a></li>
                                                                    </ul>
                                                                </div>
                ...
                <div class="sidebar-menu-wrapper">
                    ...
                    <div class="sidebar_mobile_menu">
                        ...
                        <div class="msb_widget brand_logo text-center">
                            <a href="index.html">
                                <img src="assets/images/logo/logo_25_1x.png"
                                    srcset="assets/images/logo/logo_25_2x.png 2x" alt="logo_not_found">
                            </a>
                        </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="text" name="userName" class="form-control"
                                                            value="${accountDetail.userName.trim()}">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-sm-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        ...
                                                        <!-- <input type="text" name="gender" class="form-control"
                                                            value="${accountDetail.gender == true ? 'Male' : 'Female'}"> -->
                                                    </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            <div class="footer_widget df_about_area">
                                <div class="brand_logo mb_30">
                                    <a href="index.html">
                                        <img src="assets/images/logo/logo_28_1x.png"
                                            srcset="assets/images/logo/logo_28_2x.png 2x" alt="logo_not_found">
                                    </a>
                                </div>
