<%-- 
    Document   : checkoutstep3
    Created on : Feb 17, 2024, 12:16:51 PM
    Author     : FPT-LAPTOP
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <title>Checkout 3rd Step Page - Neoncart HTML5 Template</title>
            ...
            <section class="checkout_section sec_ptb_140 clearfix">
                <div class="container">
                    ...
                    <ul class="checkout_step ul_li clearfix">
                        ...
                        <li class="activated"><a href="${pageContext.request.contextPath}/views/common/checkoutstep2.jsp"><span>02.</span> Checkout</a></li>
                        <li class="active"><a href="${pageContext.request.contextPath}/views/common/checkoutstep3.jsp"><span>03.</span> Order Completed</a></li>
                    </ul>
