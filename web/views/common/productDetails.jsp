...
<html lang="en">
    ...
    <head>
        ...
        <title>Public Product Details - Brava Shop</title>
                        ...
                        <c:otherwise>
                            <div class="user_info">
                                ...
                                <ul class="settings_options ul_li_block clearfix">
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/authen?action"><i class="fal fa-sign-out-alt"></i> Login</a></li>
                                </ul>
                            </div>
                        </c:otherwise>
                    </c:choose>
                            ...
                            <div class="details_content">
                                ...
                                <c:choose>
                                    <c:when test="${not empty listCp && not empty listSp}">
                                        <c:if test="${not empty StockOfProductDetail}">
                                            <p class="font-weight-bold" id="stockInfo"> <i class="feather icon-database mr-50 font-medium-2"></i>Stock: ${StockOfProductDetail}</p>
                                        </c:if>
                                        ...
                                        <div class="item_color_list mb_15 d-flex align-items-center clearfix">
                                            <h4 class="list_title mb-0 text-uppercase">Category: <a href="#">${pf.category}</a></h4>
                                        </div>
                                        <div class="item_color_list mb_15 d-flex align-items-center clearfix">
                                            <h4 class="list_title mb-0 text-uppercase">Brand: <a href="#">${pf.brand}</a></h4>
                                        </div>    
                                        <c:choose>
                                ...
                                <ul class="btns_group ul_li clearfix">
                                    <li>
                                        <div class="quantity_input">
                                            ...
                                            <input class="input_number" type="text" id="quantityInput" value="1">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:when test="${not empty sizeIdA && not empty colorIdA && not empty genderIdA && not empty sessionScope.account && empty sessionScope.account.address}">
                                            <li>
