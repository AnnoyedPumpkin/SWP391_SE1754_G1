...
<html lang="en">
    ...
    <body>
        <header class="header_section fashion_minimal_header header-page-cust clearfix">
        ...
        <section style="margin-top: 150px" id="cart_items">
            <div class="container">
                ...
                <div class="table-responsive cart_info">
                    <table class="table table-condensed">
                        <thead>
                            <tr class="cart_menu">
                                <td class="orderId">Image</td>
                                <td class="dateOrder">Name</td>
                                <td class="address">Price</td>
                                <td class="totalPrice">Quantity</td>
                                <td class="status">TotalPrice</td>      
                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach items="${list}" var="o">
                                <tr>
                                    <td class="cart_product">
                                        <img style="width: 100px; height: 100px" src="${o.imageLink}">
                                    </td>
                                    <td class="cart_description">
                                        <h4><a href="">${o.productName}</a></h4>
                                    </td>
                                    <td class="cart_price">
                                        <p><fmt:formatNumber type="currency" value="${o.price}" /> vnd</p>
                                    </td>
                                    <td class="cart_total">
                                        <p class="">${o.quantity}</p>
                                    </td>
                                    <td class="cart_total">
                                        <p class="cart_total_price"><fmt:formatNumber type="currency" value="${o.totalPrice}" />vnd</p>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-center paged-content">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item">
                                            <a href="order?action=invoiceDetail&index=${pageSelected -1}&invoiceId=${invoiceId}" class="page-link">Previous</a>
                                        </li>
                                    </c:otherwise>
                                </c:choose>
                                <c:forEach begin="1" end="${endPage}" var="i">
                                    <li class="page-item"><a class="${pageSelected == i ? "page-link active-paged" : "page-link"}" href="order?action=invoiceDetail&index=${i}&invoiceId=${invoiceId}">${i}</a></li>
                                    </c:forEach>
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item">
                                            <a href="order?action=invoiceDetail&index=${pageSelected + 1}&invoiceId=${invoiceId}" class="page-link">Next</a>
                                        </li>
                                    </c:otherwise>
                                </c:choose>
