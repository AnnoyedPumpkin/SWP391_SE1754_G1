...
<html lang="en">
    ...
    <body class="home_fashion">
                        ...
                        <div class="col-6">
                            <div class="brand_logo">
                                <a class="brand_link" href="index.html">
                                    <img src="${pageContext.request.contextPath}/assets/images/logo/logo_13_1x.png" srcset="${pageContext.request.contextPath}/assets/images/logo/logo_13_2x.png 2x" alt="logo_not_found">
                                </a>
                            </div>
                        </div>
                            ...
                            <ul class="action_btns_group ul_li_right clearfix">
                                ...
                                <li>
                                    <button type="button" class="cart_btn">
                                        ...
                                        <c:if test="${not empty sessionScope.cartProductCount}">
                                        <span class="btn_badge">${sessionScope.cartProductCount}</span>
                                        </c:if>
                                    </button>
                                </li>
                            </ul>
        ...
        <main>
            ...
            <div class="sidebar-menu-wrapper">
                <div class="cart_sidebar">
                        ...
                        <c:forEach items="${shopping_cart_details}" var="p">
                            <li>
                                ...
                                <div class="item_content">
                                    <h4 class="item_title">${p.p.name} x(${p.c_Det.quantity})</h4>
                                    Size: ${p.s.size}
                                    ...
                                    <br>
                                    <span class="price-text">Unit price: ${p.p.price}VND</span>
                                </div>
                                <span hidden class="total_price">${p.c_Det.quantity * p.p.price}VND</span>
                                <form id="deleteProductForm" action="home?action=deleteProduct" method="post">
                    ...
                    <script>
                        ...
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            totalPrices.forEach(function (totalPrice) {
                                var price = parseFloat(totalPrice.textContent);
                                if (!isNaN(price)) {
                                    totalPriceSum += price;
                                }
                            });
                            var totalPriceSumElement = document.getElementById('total_price_sum');
                            if (totalPriceSumElement) {
                                totalPriceSumElement.textContent = totalPriceSum.toFixed(1) + 'VND';
                            }
                        });
                    </script>   
                    ...
                    <ul class="btns_group ul_li_block clearfix">
                        <li><a href="${pageContext.request.contextPath}/Checkout"> View Cart List</a></li>
                    </ul>
                </div>
            ...
            <section class="advertisement_section clearfix">
                <div class="container-fluid p-0">
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-6">
                            <div class="fashion_advertisement" data-background="${pageContext.request.contextPath}/assets/images/offer/fashion/img_01.jpg">
                                <div class="item_content">
                        ...
                        <div class="col-lg-6">
                            <div class="fashion_advertisement" data-background="${pageContext.request.contextPath}/assets/images/offer/fashion/img_02.jpg">
            ...
            <!-- product_section - start
            ================================================== -->
            <section class="product_section sec_ptb_140 clearfix" data-background="${pageContext.request.contextPath}/assets/images/backgrounds/bg_09.jpg">
                <div class="container">
