                    ...
                    <div class="user_info">
                        ...
                        <div class="profile_info clearfix">
                            ...
                            <div class="user_content">
                                ...
                                <c:if test="${sessionScope.customer != null }">
                                    <h4 class="user_name">${sessionScope.customer.getEmail()}</h4>
                                    <span class="user_title">${sessionScope.customer.getRoleId()}</span>
                                </c:if>
                        ...
                        <ul class="settings_options ul_li_block clearfix">
                            ...
                            <li><a href="#!"><i class="fal fa-user-cog"></i> Settings</a></li>
                                <c:if test="${sessionScope.customer == null}">
                                <li><a href="${pageContext.request.contextPath}/authen?action=login"><i class="fal fa-sign-out-alt"></i> Login</a></li>
                                </c:if>
                                <c:if test="${sessionScope.customer != null}">
