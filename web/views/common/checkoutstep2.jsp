...
<html lang="en">
    ...
    <head>
        ...
        <title>Checkout 2nd Step Page - Neoncart HTML5 Template</title>
    ...
    <body>
                        ...
                        <div class="col-lg-3">
                            <div class="brand_logo">
                                <a class="brand_link" href="index.html">
                                    <img src="${pageContext.request.contextPath}/assets/images/logo/logo_27_1x.png"
                                         srcset="${pageContext.request.contextPath}/assets/images/logo/logo_27_2x.png 2x" alt="logo_not_found">
                                </a>
                                                    ...
                                                    <ul class="home_pages ul_li clearfix">
                                                        <li>
                                                            <a href="home_carparts.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/carparts.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_classic_ecommerce.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/classic_ecommarce.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_creative_onelook.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/creative_onelook.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_electronic.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/electronic.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_fashion.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/fashion.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_fashion_minimal.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/fashion_minimal.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_furniture.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/furniture.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_gadget.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/gadget.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_lookbook_creative.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/lookbook_creative.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_lookbook_slide.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/lookbook_slide.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_medical.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/medical.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_modern.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/modern.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_modern_minimal.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/modern_minimal.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_motorcycle.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/motorcycle.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_parallax_shop.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/parallax_shop.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_simple_shop.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/simple_shop.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_single_story_black.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/single_story_black.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_single_story_white.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/single_story_white.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_sports.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/sports.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_supermarket.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/supermarket.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                        ...
                                                        <li>
                                                            <a href="home_watch.html">
                                                                <span class="item_image">
                                                                    <img src="${pageContext.request.contextPath}/assets/images/home_pages/watch.png"
                                                                         alt="image_not_found">
                                                                </span>
                                                    ...
                                                    <div class="row mt__30">
                                                        <div class="col-lg-3">
                                                            ...
                                                            <div class="page_links">
                                                                ...
                                                                <ul class="ul_li_block">
                                                                    <li><a href="classic_ecommerce_shop.html">Shop Page</a>
                                                                    </li>
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="page_links">
                                                                ...
                                                                <ul class="ul_li_block">
                                                                    <li><a href="fashion_minimal_shop.html">Shop Page</a>
                                                                    </li>
                                                            ...
                                                            <div class="page_links">
                                                                ...
                                                                <ul class="ul_li_block">
                                                                    ...
                                                                    <li><a href="gadget_shop_details.html">Shop Details</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3">
                                                            ...
                                                            <div class="page_links">
                                                                ...
                                                                <ul class="ul_li_block">
                                                                    <li><a href="modern_minimal_shop.html">Shop Page</a>
                                                                    </li>
                                                            ...
                                                            <div class="page_links">
                                                                ...
                                                                <ul class="ul_li_block">
                                                                    ...
                                                                    <li><a href="modern_shop_details.html">Shop Details</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            ...
                                                            <div class="page_links">
                                                                ...
                                                                <ul class="ul_li_block">
                                                                    <li><a href="motorcycle_shop_grid.html">Shop Grid</a>
                                                                    </li>
                                                                    <li><a href="motorcycle_shop_list.html">Shop List</a>
                                                                    </li>
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="page_links">
                                                                ...
                                                                <ul class="ul_li_block">
                                                                    ...
                                                                    <li><a href="simple_shop_details.html">Shop Details</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            ...
                                                            <div class="page_links">
                                                                ...
                                                                <ul class="ul_li_block">
                                                                    ...
                                                                    <li><a href="sports_shop_details.html">Shop Details</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            ...
                                                            <div class="page_links">
                                                                ...
                                                                <ul class="ul_li_block">
                                                                    <li><a href="lookbook_creative_shop.html">Shop Page</a>
                                                                    </li>
        ...
        <main>
            ...
            <section class="breadcrumb_section text-white text-center text-uppercase d-flex align-items-end clearfix"
                     data-background="${pageContext.request.contextPath}/assets/images/breadcrumb/bg_01.jpg">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            <div class="footer_widget df_about_area">
                                <div class="brand_logo mb_30">
                                    <a href="index.html">
                                        <img src="${pageContext.request.contextPath}/assets/images/logo/logo_28_1x.png"
                                             srcset="${pageContext.request.contextPath}/assets/images/logo/logo_28_2x.png 2x" alt="logo_not_found">
                                    </a>
                                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <p class="copyright_text mb-0">
                                @2020 Designed By <a href="#!" class="author_link text-white">jthemes</a>.
                            </p>
                        </div>
